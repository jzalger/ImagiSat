...
byte wb::setWBFrequency(long freq)
{
...
*/
void wb::tuneWBFrequency(signed char increment)
{
...
unsigned int wb::getWBFrequency()
{
...
void wb::setMuteVolume(boolean mute)
{
...
byte wb::command_Tune_Freq(unsigned int frequency)
{
...
unsigned int wb::command_Tune_Status(byte intAck, byte returnIndex)
{
...
byte wb::command_Get_Rev(byte returnIndex)
{
...
byte wb::command_SAME_Status(byte returnIndex)
{
...
byte wb::command_RSQ_Status(byte returnIndex)
{
...
*/
byte wb::command_Get_Int_Status(void)
{
...
void wb::writeCommand(byte cmdSize, byte * command, byte replySize, byte * reply)
{
  waitForCTS();
...
// property address.
unsigned int wb::getProperty(unsigned int property)
{
...
//  value.
void wb::setProperty(unsigned int propNumber, unsigned int propValue)
{
...
void wb::i2cReadBytes(byte number_bytes, byte * data_in)
{
  int timeout = 1000;
...
void wb::i2cWriteBytes(uint8_t number_bytes, uint8_t *data_out)
{
